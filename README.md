# Mevsim ve Aylar Uygulaması (WinForms)
...
Bu proje, C# ve Windows Forms (WinForms) kullanılarak geliştirilmiş bir temel araç ve kontrol uygulamasıdır. Proje, öğrencilerin sınav notlarını girerek ortalama ve geçme/kalma durumlarını hesaplamalarına olanak tanır. Kullanıcı, öğrenci bilgilerini (ad-soyad, ders, numara) girip ListBox’a aktarabilir ve kaydedilen bilgileri görüntüleyebilir. Proje ayrıca MessageBox kullanımı, for ve while döngüleri, diziler ve karar yapıları gibi temel programlama kavramlarını uygulamalı olarak göstermektedir.



<img width="1201" height="713" alt="Image" src="https://github.com/user-attachments/assets/7f5f6ec8-4582-44a9-b037-28f5dce9ba1b" />
